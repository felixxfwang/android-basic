...
import com.blankj.utilcode.util.PermissionHelper.OnRationaleListener.ShouldRequest;
...
public final class PermissionHelper {
     ...
     *
     * @param permissions The permissions.
     * @return the single {@link PermissionHelper} instance
     */
    public static PermissionHelper permission(final String[] permissions) {
        return new PermissionHelper(permissions);
    }

    private PermissionHelper(final String[] permissions) {
     ...
     * @return the single {@link PermissionHelper} instance
     */
    public PermissionHelper rationale(final OnRationaleListener listener) {
     ...
     * @return the single {@link PermissionHelper} instance
     */
    public PermissionHelper callback(final SingleCallback callback) {
     ...
     * @return the single {@link PermissionHelper} instance
     */
    public PermissionHelper theme(final ThemeCallback callback) {
    ...
    public void request() {
        ...
        String[] permissions = mPermissionsParam;
        for (String permission : permissions) {
            ...
            if (!isIncludeInManifest) {
                ...
                Log.e("PermissionUtils", "U should add the permission of " + permission + " in manifest.");
            }
        }
